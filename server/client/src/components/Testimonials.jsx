...
const Testimonials = () => {
  return (
    <div>
      ...
      <h1 className="text-center text-3xl lg:text-4xl font-semibold bg-gradient-to-r from-gray-400 via-gray-600 to-gray-900 bg-clip-text text-transparent ">Customer Testimonials</h1>
