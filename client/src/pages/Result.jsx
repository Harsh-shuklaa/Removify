...
const Result = () => {
  return (
      ...
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        <div className=" flex flex-col sm:grid grid-cols-2 gap-8 ">
          ...
          <div className="flex flex-col">
            ...
            <div className="rounded-md border border-gray-300 h-full relative bg-layer oberflow-hidden">
              <img src={assets.image_wo_bg} alt="" />
              {/* <div className='absolute right-1/2 bottom-1/2 transform translate-x-1/2 trannslate-y-1/2'>
    <div className='border-4 border-violet-600 rounded-full h-12 w-12 border-t-transparent animate-spin'>
        ...
        {/* .........Button............... */}
        <div className="flex justify-center sm:justify-end items-center flrx-wrap gap-4 mt-6">
