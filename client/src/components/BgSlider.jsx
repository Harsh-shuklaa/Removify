...
const BgSlider = () => {
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
      {/* Title */}
      <h1 className=' mb-12 sm:mb-20 text-center text-3xl lg:text-4xl font-semibold bg-gradient-to-r from-gray-400 via-gray-600 to-gray-900 bg-clip-text text-transparent '>Real-time Preview: Removed <br />Background Effect</h1>
